...
> CharactersCharacterIdAttributesGet get_characters_character_id_attributes(character_id, accept_language=accept_language, if_none_match=if_none_match, x_compatibility_date=x_compatibility_date, x_tenant=x_tenant)
...
> List[CharactersCharacterIdSkillqueueGetInner] get_characters_character_id_skillqueue(character_id, accept_language=accept_language, if_none_match=if_none_match, x_compatibility_date=x_compatibility_date, x_tenant=x_tenant)
...
> CharactersCharacterIdSkillsGet get_characters_character_id_skills(character_id, accept_language=accept_language, if_none_match=if_none_match, x_compatibility_date=x_compatibility_date, x_tenant=x_tenant)
