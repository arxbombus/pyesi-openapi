...
> CharactersCharacterIdClonesGet get_characters_character_id_clones(character_id, accept_language=accept_language, if_none_match=if_none_match, x_compatibility_date=x_compatibility_date, x_tenant=x_tenant)
...
with pyesi_openapi.ApiClient(configuration) as api_client:
    ...
    api_instance = pyesi_openapi.ClonesApi(api_client)
...
> List[int] get_characters_character_id_implants(character_id, accept_language=accept_language, if_none_match=if_none_match, x_compatibility_date=x_compatibility_date, x_tenant=x_tenant)
