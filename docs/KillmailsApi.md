...
> List[CharactersCharacterIdKillmailsRecentGetInner] get_characters_character_id_killmails_recent(character_id, page=page, accept_language=accept_language, if_none_match=if_none_match, x_compatibility_date=x_compatibility_date, x_tenant=x_tenant)
...
with pyesi_openapi.ApiClient(configuration) as api_client:
    ...
    api_instance = pyesi_openapi.KillmailsApi(api_client)
...
> List[CharactersCharacterIdKillmailsRecentGetInner] get_corporations_corporation_id_killmails_recent(corporation_id, page=page, accept_language=accept_language, if_none_match=if_none_match, x_compatibility_date=x_compatibility_date, x_tenant=x_tenant)
...
> KillmailsKillmailIdKillmailHashGet get_killmails_killmail_id_killmail_hash(killmail_hash, killmail_id, accept_language=accept_language, if_none_match=if_none_match, x_compatibility_date=x_compatibility_date, x_tenant=x_tenant)
